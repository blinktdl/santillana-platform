...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Licencias=function(){function Licencias(){_classCallCheck(this,Licencias);}_createClass(Licencias,[{key:'init',value:function init(){this.duplicateSubmitButton();this.addClassToSearchInputParent();}},{key:'duplicateSubmitButton',value:function duplicateSubmitButton(){var originalButton=document.querySelector('#admin.admin.adminlist form .smenu .row .row .col-xs-12.r button.btn.btn-default');if(originalButton){var clonedButton=originalButton.cloneNode(true);var sMenuElementAll=document.querySelectorAll('#admin.admin.adminlist form .smenu');if(sMenuElementAll.length){var sMenuElement=sMenuElementAll[0];sMenuElement.appendChild(clonedButton);}}}},{key:'addClassToSearchInputParent',value:function addClassToSearchInputParent(){var searchInputParent=document.querySelector('#admin.admin.adminlist .search');if(searchInputParent){searchInputParent.parentNode.classList.add('sm-text-container');}}}]);return Licencias;}();exports.default=Licencias;
